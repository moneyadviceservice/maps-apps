...
const copy: Copy = {
  ...
  preparingForRedundancy: {
    en: (
      <>
        <H2 className="mb-8 text-blue-800 md:text-5xl">
          Preparing for redundancy
        </H2>
        <div className="flex flex-col w-full lg:flex-row">
          <div className="w-full mb-8 mr-0 lg:mb-0 lg:mr-8 lg:flex-1 lg:w-1/2">
            <InformationCallout
              variant="default"
              testId=""
            ...
            >
              ...
              {/* This will push the last element down */}
    ...
    cy: (
      <>
        <H2 className="mb-8 text-blue-800">Paratoi ar gyfer diswyddo </H2>
        <div className="flex flex-col w-full lg:flex-row">
          <div className="w-full mb-8 mr-0 lg:mb-0 lg:mr-8 lg:flex-1 lg:w-1/2">
            <InformationCallout
              variant="default"
  ...
  printedGuide: {
    en: (
      <>
        <H2 className="text-blue-800 md:text-5xl">Read our printed guide</H2>
        <span>
          <p>
            <Link
    ...
    cy: (
      <>
        <H2 className="text-blue-800">Darllenwch ein canllaw printiedig</H2>
        <span>
          <p>
            <Link
              href="/files/RH_Apr25_Ed1_Eng.pdf"
...
// Based on your <b>£{formatNumber(salary.amount)} yearly</b> salary, your <b>£{formatNumber(redundancyPay)}</b> redundancy money is roughly equivalent to <b>{monthsWorthOfSalary.toFixed(1)}</b> months of salary.
