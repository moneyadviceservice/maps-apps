...
export const ResultsBox = ({
  ...
  return (
    <div className="border-[8px] rounded-bl-[36px] border-teal-300 p-6 lg:min-w-[524px] lg:mr-8 mb-4 lg:mb-0">
      {amount}
...
const translateArray = (
  ...
  translationGroups.forEach((value: TranslationGroup) => result.push(z(value)));
