...
export default function Summary({
  ...
  const canonicalUrl = getCanonicalUrl(router.asPath, lang);
      ...
      <BudgetPlanner {...props} data={data} tabName="summary">
        <NoSummaryAvailable>
          <Button
            ...
            onClick={(e) => {
              ...
              router.push({
                pathname: `/${locale}/budget-planner/${nextTab.name}`,
                query: {
                  ...router.query,
                  returning: false,
        ...
        <div className="flex flex-col justify-between pb-20 print:hidden t-social-sharing sm:flex-row">
          <SocialShareTool
            ...
            subject={z({
              en: 'Budget Planner – Free online daily, monthly and yearly budget planning tool',
              cy: 'Cynlluniwr Cyllideb - Teclyn cynllunio cyllideb ddyddiol, fisol, a blynyddol am ddim ar-lein',
            })}
          />
        </div>
      </BudgetPlanner>
  ...
  return (
    ...
    >
      ...
      <div className="max-w-full mb-4 space-y-6 t-summary-intro">
        <Callout
          className={`px-8 md:px-10 pt-6 pb-10 ${additionalClassName}`}
      ...
      <Heading
        level="h3"
        component="h2"
        className="my-6 md:my-8 text-blue-800 text-[28px] md:text-[44px] font-[700] leading-10"
      >
        {z({
        ...
        <div className="print:p-2 print:border-none sm:w-3/5 md:w-2/3 border border-slate-400 rounded-[4px] t-summary-breakdown">
          <SummarySpendBreakdown
            ...
            onEdit={(e: any, name: string) => {
              e.preventDefault();
              router.push(`/${locale}/budget-planner/${name}`);
            }}
          >
            {' '}
          </SummarySpendBreakdown>
      ...
      >
        <ResetCalculator
          ...
          onCancelClick={(e) => {
            e.preventDefault();
            router.push(`/${locale}/budget-planner/summary`);
            setDialogIsOpen(false);
          }}
        />
      </Dialog>
      ...
      <div className="flex flex-col justify-between print:hidden t-social-sharing sm:flex-row ">
        <SocialShareTool
          url={canonicalUrl}
          title={z(shareToolContent.title)}
          subject={z({
      ...
      <ToolFeedback className="ml-[-22px] mr-[-22px]" />
    </BudgetPlanner>
  );
}
