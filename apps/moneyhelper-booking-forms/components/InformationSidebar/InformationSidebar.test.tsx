...
describe('InformationSidebar Component', () => {
  ...
  it('renders component correctly', () => {
    const { container } = render(<InformationSidebar mainFlow="test-flow" />);
    expect(container).toMatchSnapshot();
  });

  it('renders null when mainFlow is not provided', () => {
    const { container } = render(<InformationSidebar mainFlow="" />);
