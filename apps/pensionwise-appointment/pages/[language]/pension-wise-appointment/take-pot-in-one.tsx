  ...
  return {
    props: {
      data: {
        ...
        embeddedTool: {
          url: {
            en: `${process.env.PWD_EMBEDDED_TOOLS_URL}/en/take-whole-pot-calculator?isEmbedded=true`,
            cy: `${process.env.PWD_EMBEDDED_TOOLS_URL}/cy/take-whole-pot-calculator?isEmbedded=true`,
          },
