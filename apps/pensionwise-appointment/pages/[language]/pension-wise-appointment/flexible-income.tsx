  ...
  return {
    props: {
      data: {
        ...
        embeddedTool: {
          url: {
            en: `${process.env.PWD_EMBEDDED_TOOLS_URL}/en/adjustable-income-estimator?isEmbedded=true`,
            cy: `${process.env.PWD_EMBEDDED_TOOLS_URL}/cy/adjustable-income-estimator?isEmbedded=true`,
          },
