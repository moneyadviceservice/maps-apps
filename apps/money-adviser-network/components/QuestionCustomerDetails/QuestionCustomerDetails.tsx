        ...
        <Errors errors={phoneError} className="mb-4 max-w-[410px]">
          ...
          <div className="flex w-full">
            ...
            <input
              id={phoneField}
              className={twMerge(
                'w-full md:max-w-[408px] h-10 px-3 m-px mt-2 ml-0 text-lg border-gray-800 border-t border-b border-r border-l-0 rounded-r focus:outline-purple-700 focus:shadow-focus-outline',
              )}
