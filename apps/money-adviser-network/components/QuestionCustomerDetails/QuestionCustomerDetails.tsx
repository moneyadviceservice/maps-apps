        ...
        <Errors errors={phoneError} className="mb-4 max-w-[410px]">
          ...
          <div className="flex w-full">
            ...
            <input
              id={phoneField}
              className={twMerge(
                'px-3 m-px mt-2 ml-0 w-full h-10 text-lg rounded-r border-t border-r border-b border-l-0 border-gray-800 md:max-w-[408px] focus:outline-none focus:shadow-focus-outline',
              )}
