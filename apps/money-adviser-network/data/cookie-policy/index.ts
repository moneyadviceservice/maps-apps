      ...
      },
      {
        ...
        paragraphs: t({
          ...
          cy: [
            ...
            "Darganfyddwch sut i reoli cwcis gan Swyddfa'r Comisiynydd Gwybodaeth.",
          ],
        }),
      },
      {
        ...
        paragraphs: t({
          en: [
            "These cookies are essential for the website work, and to keep your information secure. Without these, the website won't work properly. Because of this, you cannot disable them. They do not store any personal data. They expire as shown in the table below.",
            'If you do not want us to use them, you can turn off cookies in your web browser, but the service may not work properly.',
          ],
          cy: [
            "Mae'r cwcis hyn yn hanfodol er mwyn i'r wefan weithio, ac i gadw eich gwybodaeth yn ddiogel. Heb y rhain, ni fydd y wefan yn gweithio'n iawn. Oherwydd hyn, ni allwch eu hanalluogi. Nid ydynt yn cadw unrhyw ddata personol. Maent yn dod i ben fel y dangosir yn y tabl isod.",
      ...
      },
      {
        ...
        paragraphs: t({
          en: [
            ...
            "If you do not wish to use them, you can turn Functional cookies off using the 'Cookie preferences' link in the footer of this page.",
          ],
          cy: [
            ...
            "Os nad ydych am eu defnyddio, gallwch ddiffodd cwcis Swyddogaethol gan ddefnyddio'r ddolen 'Dewisiadau cwcis' ar waelod y dudalen hon.",
          ],
        }),
        table: {
          caption: t({
        ...
        table: {
          ...
          rows: t({
            ...
            cy: [
              ...
              ['li_gc', '', '6 mis'],
              ['lidc', '', '1 diwrnod'],
              ['Muc_ads', '', '1 flwyddyn and 1 month'],
              ['Personalization_id', '', '8 wythnosau'],
              ['test_cookie', '', '15 munud'],
              ['__adal_ca', '', '6 mis'],
              ['__adal_cw', '', '7 diwrnod'],
              ['__adal_id', '', '1 flwyddyn'],
              ['__adal_ses', '', '30 munud'],
              ['_fbp', '', '3 mis'],
              ['_gcl_au', '', '3 mis'],
            ],
