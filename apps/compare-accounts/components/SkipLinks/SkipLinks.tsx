...
const SkipLinks = ({ skipLinks }: Props) => {
  ...
  const buttonStyles =
    'relative outline-none font-bold text-sm p-3 pr-6 pl-6 rounded bg-pink-600 text-white shadow-bottom-gray mr-2 top-1';
  const focusStyles =
    'focus:text-gray-800 focus:bg-yellow-200 focus:border-b-purple-800 focus:border-b-4';
  const hoverStyles = 'hover:bg-white hover:border-none hover:text-blue-800';
