      ...
      <div className="space-y-10 lg:max-w-[840px] mt-10">
        ...
        <div>
          <Link
            ...
            className="w-full text-center block md:w-auto md:inline-flex  justify-between  border-0 text-white bg-pink-600 hover:bg-pink-800 hover:shadow-none hover:text-white active:bg-pink-900 active:outline-yellow-200 active:text-white t-button px-3 py-2 font-semibold rounded outline-none shadow-bottom-gray gap-2 cursor-pointer focus:bg-yellow-200 focus:outline-purple-700 focus:outline-[3px] focus:outline-offset-0 focus:text-gray-800 focus:shadow-none active:shadow-none active:outline-[3px] active:outline-offset-0 t-primary-button"
          >
            {z({
