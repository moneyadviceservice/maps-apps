...
export const IntendedUseSelect = ({
  ...
  return (
    <>
      ...
      {showInput && (
        <div className="relative h-[49px] max-w-[458px] mt-4">
          <input
            data-testid="other-input"
            name="other_use"
            className="w-full border border-slate-400 rounded px-2 py-1 h-[49px]"
            defaultValue={otherDefaultVal ?? ''}
          />
        </div>
      )}
    </>
