...
const DesktopHeader = ({
  ...
  return (
    <div className="hidden lg:block">
      <div className="relative bg-blue-600 print:hidden lg:bg-gray-300 lg:h-[101px]">
        <Container className="flex items-center justify-center lg:justify-normal max-w-[1272px]">
          ...
          <div className="items-center hidden ml-auto lg:flex">
            <AccountLinks accountLinks={accountLinks} language={language} />
            <LanguageLink
              router={router}
              classNames={[
      ...
      <nav>
        <ul className="flex">
          {accountLinks?.map((i, index) => {
            const space = index === 0 ? <span className="px-1">/</span> : <></>;
            return (
