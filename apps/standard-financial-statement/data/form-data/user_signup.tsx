  ...
  return [
    ...
    },
    {
      ...
      errors: {
        ...
        user_already_exists: z({
          ...
          cy: 'Mae’r defnyddiwr eisoes yn bodoli',
        }),
        not_allowed: z({
          en: 'Email address not allowed',
          cy: 'Cyfeiriad e-bost heb ei ganiatáu',
        }),
      },
    },
    {
    ...
    },
    {
      ...
      errors: {
        ...
        custom: z({
          en: 'Password strength too weak',
          cy: 'Password strength too weak',
        }),
      },
    },
    codeOfConduct(z),
