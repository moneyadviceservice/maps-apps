...
import { requireAdminAuthentication } from 'utils/auth/requireAdminAuthentication';
...
export const getServerSideProps: GetServerSideProps = async (context) => {
  ...
  const authResult = await requireAdminAuthentication(context);
  ...
  const user = {
    name: authResult.session?.account?.name,
    email: authResult.session?.account?.username,
  };
