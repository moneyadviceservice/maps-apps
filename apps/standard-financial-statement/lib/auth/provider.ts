...
export const login = async (
  ...
  const authCodeRequestParams = { state, scopes: [] };
...
export const logout = async (
  ...
  const logoutUri = `${msalConfig.auth.authority}${TENANT_SUBDOMAIN}.onmicrosoft.com/oauth2/v2.0/logout?post_logout_redirect_uri=${logoutRedirect}`;
