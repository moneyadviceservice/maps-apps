...
for (const locale of localeLBTT) {
  describe(`Land Transaction Tax - ${locale.toUpperCase()}`, () => {
    ...
    it.skip('Verifies LBTT for a First Time Buyer', () => {
    ...
    it.skip('Verifies LBTT for a Next Home Buyer', () => {
    ...
    it.skip('Verifies LBTT for Additional Property/Second Home Buyer - Property Price : 39K', () => {
    ...
    it.skip('Verifies LBTT for Additional Property/Second Home Buyer - Property Price : 125K', () => {
    ...
    it.skip('Verifies LBTT for Additional Property/Second Home Buyer - Property Price : 275K', () => {
    ...
    it.skip('Verifies LBTT for Additional Property/Second Home Buyer - Property Price : 310K', () => {
    ...
    it.skip('Verifies LBTT for Additional Property/Second Home Buyer - Property Price : 490K', () => {
    ...
    it.skip('Verifies LBTT for Additional Property/Second Home Buyer - Property Price : 937K', () => {
    ...
    it.skip('Verifies LBTT for Additional Property/Second Home Buyer - Property Price : 62000K', () => {
    ...
    it.skip('Verifies LBTT for Additional Property/Second Home Buyer - Property Price : 1000000K', () => {
