...
import { type DoughnutChartData } from '../../data/chartScenario.types';
...
class DoughnutChart {
  ...
  private rightDoughnutColours: Record<string, DoughnutRings> = {
    filled: {
      inner: 'stroke-teal-400 fill-white',
      path: 'stroke-teal-400 fill-teal-400',
      outer: 'stroke-teal-400 fill-white',
    },
    unfilled: {
      inner: 'stroke-slate-500 fill-white',
      path: 'stroke-slate-500 fill-teal-400',
      outer: 'stroke-slate-500 fill-white',
    },
  };
