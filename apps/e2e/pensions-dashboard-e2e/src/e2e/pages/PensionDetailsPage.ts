  ...
  async verifyCommonHeaderAndIllustrationDate(
    ...
    if (payableDateERI !== undefined) {
      ...
      retirementDateToolTipCheck = retirementDateToolTipText.includes(
        `The pension retirement date is the date your provider expects you to start taking money from this pension scheme. You don’t have to retire or take your pension on this date - you can usually change it by contacting them.Close`,
      );
    }
    ...
    if (dataIllustrationDate !== undefined) {
      ...
      informationLastUpdatedTooltipCheck =
        informationLastUpdatedToolTipText.includes(
          `This is the date the pension provider calculated your estimated income.Close`,
        );
    }
    return (
      referenceNumberCheck &&
