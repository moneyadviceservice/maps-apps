...
type WelcomePage = {
  ...
  welcomePageLoads(page: Page, locale?: Locale): Promise<void>;
...
const welcomePage: WelcomePage = {
  ...
  async welcomePageLoads(page: Page, locale: Locale = 'en'): Promise<void> {
    const welcomeMessages = {
      en: 'Welcome to the MoneyHelper Pensions Dashboard',
      cy: 'Croeso i Ddangosfwrdd Pensiynau HelpwrArian',
    };

    await page.getByText(welcomeMessages[locale]).waitFor();
  },
