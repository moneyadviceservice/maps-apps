...
interface ContactUsPage {
  ...
  getPageTitle(page: Page): Locator;
  getIntroText(page: Page): Locator;
  getParagraph(page: Page): Locator;
  getHyperlink(page: Page): Locator;
  getContactUsFormHeading(page: Page): Locator;
  getOnlineFormButton(page: Page): Locator;
  getBackButton(page: Page): Locator;
  clickHelpAndSupportContactUs(page: Page): Promise<void>;
  getBackToTopAnchor(page: Page): Locator;
  getAccessibleOptionsHeading(page: Page): Locator;
}
...
const contactUsPage: ContactUsPage = {
  ...
  getAccessibleOptionsHeading(page: Page) {
    return page.getByRole('heading', { name: 'Accessibility options' });
  },
