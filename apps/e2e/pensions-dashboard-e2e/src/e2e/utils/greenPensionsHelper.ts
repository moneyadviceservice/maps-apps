...
async function verifyStatePensionDetailsPage(
  ...
  if (data.apMonthlyAmountData !== null) {
    const expectedApValueText = `£${data.apMonthlyAmountData.toLocaleString()} a month or £${data.apAnnualAmountData.toLocaleString()} a year`;
  ...
  if (data.eriMonthlyAmountData !== null) {
    const expectedEriValueText = `£${data.eriMonthlyAmountData.toLocaleString()} a month or £${data.eriAnnualAmountData.toLocaleString()} a year`;
