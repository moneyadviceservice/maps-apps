  ...
  projects: [
    {
      name: 'default',
      testIgnore:
        /\/(account|firm-details|trip-cover|reregistration|fca-status|firm-directory-actions)\.spec\.ts$/,
    },
    {
      name: 'self-serve',
      testMatch:
        /\/(account|firm-details|trip-cover|reregistration|fca-status)\.spec\.ts$/,
      workers: 1,
    },
    {
