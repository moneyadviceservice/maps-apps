...
test.describe('spending-guidelines', () => {
  ...
  test('Spending Guidelines - Current year', async ({ page }) => {
    ...
    await expect(await page.screenshot({ fullPage: true })).toMatchSnapshot({
      name: 'Spending-guidelines-no-auth.png',
      maxDiffPixelRatio: 0,
    });
  });
  ...
  test('Spending Guidelines - Commentary', async ({ page }) => {
    ...
    await expect(await page.screenshot({ fullPage: true })).toMatchSnapshot({
      name: 'Spending-guidelines-commentary-no-auth.png',
      maxDiffPixelRatio: 0,
    });
  });
  ...
  test('Spending Guidelines - Commentary past years', async ({ page }) => {
    ...
    await expect(await page.screenshot({ fullPage: true })).toMatchSnapshot({
      name: 'Spending-guidelines-commentary-for-past-years-no-auth.png',
      maxDiffPixelRatio: 0,
    });
  });
  ...
  test('Spending Guidelines - Methodology', async ({ page }) => {
    ...
    await expect(await page.screenshot({ fullPage: true })).toMatchSnapshot({
      name: 'Spending-guidelines-methodology-no-auth.png',
      maxDiffPixelRatio: 0,
    });
  });
});
