...
type ApplyToUsePage = {
  ...
  checkValidationErrors(page: Page, options: ErrorOption[]): void;
  clickButton(page: Page, selector: string): void;
  fillInput(page: Page, name: string, value: string): void;
  getConfirmationLocator(page: Page): Promise<Locator>;
  selectCheckbox(page: Page, name: string, value: string): void;
  selectMultipleCheckbox(page: Page, name: string, values: string[]): void;
  selectOption(page: Page, name: string, value: string): void;
  selectRadioButton(page: Page, labelFor: string): void;
};
