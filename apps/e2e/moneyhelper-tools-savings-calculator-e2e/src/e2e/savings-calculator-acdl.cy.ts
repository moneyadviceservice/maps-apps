...
describe('SavingsCalculator-Analytics', () => {
  ...
  it('DataLayer - pageLoadReact', () => {
    const locales = ['en', 'cy'];
    const urls = [
      'savings-calculator/how-long?isEmbed=false&savingGoal=5%2C000&amount=300&amountDuration=12&saved=10%2C001&interest=5.5#results',
      'savings-calculator/how-long?isEmbed=false&savingGoal=25%2C000&amount=2%2C000&amountDuration=12&saved=1%2C000&interest=6.25#results',
      'savings-calculator/how-much?isEmbed=false&savingGoal=10%2C000&durationMonth=7&durationYear=2025&saved=&interest=5.5#results',
      'savings-calculator/how-much?isEmbed=false&savingGoal=25%2C000&durationMonth=7&durationYear=2025&saved=&interest=6.25#results',
    ];
  ...
  it('DataLayer - toolStart', () => {
    const locales = ['en', 'cy'];
    const urls = ['savings-calculator/how-long', 'savings-calculator/how-much'];
  ...
  it('DataLayer - toolCompletion', () => {
    const locales = ['en', 'cy'];
    const urls = [
      'savings-calculator/how-long?isEmbed=false&savingGoal=5%2C000&amount=400&amountDuration=12&saved=10%2C001&interest=4.5#results',
      'savings-calculator/how-much?isEmbed=false&savingGoal=5%2C000&amount=400&amountDuration=12&saved=10%2C001&interest=4.5#results',
    ];
  ...
  it('DataLayer - errorMessage', () => {
    const locales = ['en', 'cy'];
    const urls = [
      'savings-calculator/how-long?isEmbed=false&savingGoal=5%2C000&amount=&amountDuration=12&saved=10%2C001&interest=7.5#results',
      'savings-calculator/how-much?isEmbed=false&savingGoal=&durationMonth=6&durationYear=2025&saved=2%2C600&interest=5.5#results',
    ];
