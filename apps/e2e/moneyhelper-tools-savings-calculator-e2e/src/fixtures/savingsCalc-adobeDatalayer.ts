...
export const adobeDatalayer = (locale: string) => {
  return {
    ...
    'savings-calculator/how-much?isEmbed=false&savingGoal=5%2C000&amount=400&amountDuration=12&saved=10%2C001&interest=3.5#results':
      {
        page: {
          categoryL1: 'Savings',
          categoryL2: 'How to save',
