...
localeLTT.forEach((locale) => {
  describe(`Land Transaction Tax - ${locale.toUpperCase()}`, () => {
    ...
    it('Verifies LTT for a first time or next home buyer for the Property Price-£467887', () => {
    ...
    it('Verifies LTT for a first time or next home buyer for the Property Price-£550K', () => {
    ...
    it('Verifies LTT for a first time or next home buyer for the Property Price-£750K', () => {
    ...
    it('Verifies LTT for a first time or next home buyer for the Property Price-£1500K', () => {
    ...
    it('Verifies LTT for a first time or next home buyer for the Property Price-£3333333', () => {
    ...
    it('Verifies LTT for a first time or next home buyer for the Property Price-£987654321', () => {
    ...
    // Ticket #31632
    it('Verifies LTT for an addl. property or sec. home buyer for the Property Price-£39K', () => {
    ...
    it('Verifies LTT for an addl. property or sec. home buyer for the Property Price-£125K', () => {
    ...
    it('Verifies LTT for an addl. property or sec. home buyer for the Property Price-£300019', () => {
    ...
    it('Verifies LTT for an addl. property or sec. home buyer for the Property Price-£400012', () => {
    ...
    it('Verifies LTT for an addl. property or sec. home buyer for the Property Price-£937K', () => {
    ...
    it('Verifies LTT for an addl. property or sec. home buyer for the Property Price-£988882', () => {
    ...
    it('Verifies LTT for an addl. property or sec. home buyer for the Property Price-£2100K', () => {
    ...
    it('Verifies LTT for an addl. property or sec. home buyer for the Property Price-£9999999', () => {
