describe('View summary of the selected options', () => {
  ...
  it('downloads summary document', () => {
    ...
    const pages = [
      '/summary?version=1&t1=4&t1q1=1&t1q2=2&t2=4&t2q1=1&t2q2=1&t2q3=2&t3=4&t3q1=2&t4=4&t4q1=2&t5=4&t5q1=1&t5q2=1&t6=4&t6q1=2&t7=4&t7q1=2&t8=4&t8q1=2&t9=4&t9q1=2&t10=4&t10q1=2&t11=4&t11q1=2&t12=4&task=12&complete=true&urn=ASD6-8TYH',
    ...
    locales.forEach((locale) => {
      pages.forEach((page, index) => {
        ...
        cy.get('[data-testid="summary-download-form"]').then(($elem) => {
          ...
          //Verify that there is a hidden input field for the URN number
          if (index === 0)
            cy.wrap($elem)
              .get("input[id='download_appointment_summary_urn']")
