...
export const Tabs = ({ className, testId = 'tabs' }: TabsProps) => {
  ...
  const commonClasses =
    'py-2 mb-3 sm:mb-0 text-sm sm:text-base border-b-2 sm:border-b-4 sm:mr-6 md:mr-12 last:mr-0 border-gray-350 snap-start leading-4 relative z-10 flex-none font-bold text-pink-800 underline whitespace-nowrap max-sm:w-full max-sm:text-center max-sm:flex max-sm:justify-center';
  const activeClasses = 'border-b-4 border-blue-800 text-blue-800 no-underline';
      ...
      {tabs.map((tab) => {
        ...
        return (
          <Link
            ...
            href={`/${locale}/pension-details/${tab.href}`}
