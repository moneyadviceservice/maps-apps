...
export const PensionArrangementCallout = ({
  ...
  return (
    <InformationCallout key={externalAssetId} className="px-6 py-8 pb-2 mt-8">
      ...
      <div className="py-4 mt-8 border-t-1">
        <ExpandableSection
          title={t('pages.pensions-that-need-action.card.contact-heading')}
        >
