...
export const ProgressBarCurrency = ({ amount, total, suffix }: Props) => {
  ...
  return (
    <div className="relative w-full h-10 overflow-hidden bg-blue-800/20 ">
      <div className="h-full bg-blue-800" style={{ width: progress }}></div>
      <div className={twMerge(classes, 'text-base font-bold')}>
        ...
        <span
          className={twMerge(classes, 'text-blue-800')}
