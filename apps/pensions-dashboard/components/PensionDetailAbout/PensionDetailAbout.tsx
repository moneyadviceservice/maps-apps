  ...
  const listData = [
    ...
    ...(data.employmentMembershipPeriods
      ...
      .flatMap((period, index) => {
        const entries = [
          {
            title: `${t('pages.pension-details.plan-details.employer-name')} ${
              index === 0
          ...
          {
            title: t('pages.pension-details.plan-details.employer-status'),
            value: t(
        ...
        if (period.membershipEndDate) {
          entries.push({
            title: t('pages.pension-details.plan-details.employment-end-date'),
