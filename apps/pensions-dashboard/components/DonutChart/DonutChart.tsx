...
import { currencyAmount, getYearFromDate } from '../../lib/utils';
...
const FillColor: Record<string, string> = {
  [PensionType.DB]: 'fill-purple-700', // purple-700
  [PensionType.DC]: 'fill-teal-400', // teal-400
};

const StrokeColor: Record<string, string> = {
  [PensionType.DB]: 'stroke-purple-700', // purple-700
  [PensionType.DC]: 'stroke-teal-400', // teal-400
};
  ...
  return (
    <div data-testid={testId} className="mx-auto">
      <Paragraph
        ...
        className="mb-4 text-xl font-bold text-center md:text-2xl lg:mb-14"
      >
        {t(
