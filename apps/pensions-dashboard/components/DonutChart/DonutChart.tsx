...
export const DonutChart = ({
  ...
  const hasPot = calcType === PensionType.AVC || calcType === PensionType.DC;
  ...
  return (
    <div data-testid={testId} className="mx-auto">
      ...
      >
        {t(
          `pages.pension-details.details.${hasPot ? 'pot-value' : 'lump-sum'}`,
        )}
        <Markdown
          disableParagraphs
          className="ml-1 font-normal text-left"
          content={t(`tooltips.${hasPot ? 'pot-value' : 'lump-sum'}`)}
        />
      </Paragraph>
