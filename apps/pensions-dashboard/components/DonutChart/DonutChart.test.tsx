...
describe('DonutCharts', () => {
  ...
  it.each([
    [PensionType.AVC, 'Pot value'],
    [PensionType.DC, 'Pot value'],
    [PensionType.DB, 'Lump sum'],
  ])('renders the correct pension type heading', (calcType, expectedText) => {
    render(<DonutChart {...defaultProps} calcType={calcType} />);
  ...
  it.each([
    ...
    'renders correctly when no data for donut %i',
