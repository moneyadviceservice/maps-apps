...
const Page: NextPage<PageProps> = ({ backLink }) => {
  ...
  const titleKey = 'pages.cookie-policy.title';
        ...
        <div className="lg:grid lg:grid-cols-12">
          <div className="lg:col-span-10 xl:col-span-8 2xl:col-span-7">
            ...
            <Section id="2" title={t('pages.cookie-policy.title2')}>
              ...
              <Paragraph className="md:mb-6">
                {t('pages.cookie-policy.paragraph2-2')}
              </Paragraph>
              ...
              <div
                className={twMerge(
                  tableClasses,
                  '[&_td:first-of-type]:break-all text-base',
                )}
              >
                <Table
                  ...
                  data={[
                    ...
                    [
                      '_iz_sd_ss_',
                      t('pages.cookie-policy.table-rows.izSdSs'),
                      t('common.session'),
                    ],
                    [
                      '_iz_uh_ps_',
                      t('pages.cookie-policy.table-rows.izUhPs'),
                      '1-2 years',
                    ],
                    [
                      'iPlanetDirectoryPro',
                    ...
                    [
                      ...
                      <Markdown
                        key="reentry-purpose"
                        content={t('pages.cookie-policy.table-rows.reentry')}
                      />,
                      <Markdown
                        key="reentry-expires"
                        content={t(
                          'pages.cookie-policy.table-rows.findExpires15',
                        )}
                      />,
                    ],
                    [
            ...
            <Section id="3" title={t('pages.cookie-policy.title3')}>
              ...
              <Paragraph className="md:mb-6">
                {t('pages.cookie-policy.paragraph3-2')}
              </Paragraph>
              <Heading level="h3" component="h3" className="mb-3 md:pt-4">
              ...
              >
                ...
                <Table
                  ...
                  data={[
                    ...
                    [
                      '_cls_cfgver',
                      t('pages.cookie-policy.table-rows.clsCfgver'),
                      t('pages.cookie-policy.session-expiry'),
                    ],
                    [
                      '_cls_e',
                      t('pages.cookie-policy.table-rows.clsE'),
                      t('pages.cookie-policy.session-expiry'),
                    ],
                    [
                      '_cls_subs',
                      t('pages.cookie-policy.table-rows.clsSubs'),
                      t('pages.cookie-policy.session-expiry'),
                    ],
                    [
                      'rto',
                      t('pages.cookie-policy.table-rows.rto'),
                      t('pages.cookie-policy.session-expiry'),
                    ],
                  ]}
                />
              ...
              <Paragraph className="md:mb-6">
                {t('pages.cookie-policy.paragraph3-4')}
              </Paragraph>
            </Section>
            ...
            <Section id="5" title={t('pages.cookie-policy.title5')}>
              ...
              <Markdown content={t('pages.cookie-policy.paragraph5-2')} />
            </Section>
          </div>
        </div>
      </>
