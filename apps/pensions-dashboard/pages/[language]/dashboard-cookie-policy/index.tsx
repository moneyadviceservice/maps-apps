              ...
              <div className={twMerge(tableClasses)}>
                <Table
                  ...
                  data={[
                    [
                      'authorizationCode',
                      t('pages.cookie-policy.table-rows.authorizationCode'),
                      t('pages.cookie-policy.session-expiry'),
                    ],
                    [
                      'beaconId',
                    ...
                    [
                      'userSessionId',
                      t('pages.cookie-policy.table-rows.userSessionId'),
                      t('pages.cookie-policy.session-expiry'),
                    ],
                    [
                      'redirectUrl',
                      t('pages.cookie-policy.table-rows.redirectUrl'),
                      t('pages.cookie-policy.session-expiry'),
                    ],
                    [
                      'currentUrl',
                      t('pages.cookie-policy.table-rows.currentUrl'),
                      t('pages.cookie-policy.session-expiry'),
                    ],
                    [
                      'supportCurrentUrl',
                      t('pages.cookie-policy.table-rows.supportCurrentUrl'),
                      t('pages.cookie-policy.session-expiry'),
                    ],
                    [
                      'channel',
                      t('pages.cookie-policy.table-rows.channel'),
                      t('pages.cookie-policy.session-expiry'),
                    ],
                    [
                      'pensionID',
                      t('pages.cookie-policy.table-rows.pensionId'),
                      t('pages.cookie-policy.session-expiry'),
                    ],
                  ]}
                />
...
export const getServerSideProps: GetServerSideProps = async (context) => {
  ...
  const backLink = cookies.get('currentUrl') ?? '/';
