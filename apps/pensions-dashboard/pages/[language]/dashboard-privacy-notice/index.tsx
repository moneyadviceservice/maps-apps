...
const Page: NextPage<PageProps> = ({ backLink }) => {
  ...
  const titleKey = 'pages.privacy-policy.title';
        ...
        <div className="lg:grid lg:grid-cols-12">
          <div className="lg:col-span-10 xl:col-span-8 2xl:col-span-7">
            <Section id="1" title={t('pages.privacy-policy.title1')}>
              ...
              <Markdown content={t('pages.privacy-policy.paragraph1-3')} />
            ...
            <Section id="2" title={t('pages.privacy-policy.title2')}>
              ...
              <Markdown content={t('pages.privacy-policy.paragraph2-4')} />
              <Paragraph className="md:mb-6">
            ...
            <Section id="3" title={t('pages.privacy-policy.title3')}>
              ...
              />
              <List
                items={tList('pages.privacy-policy.items3-1-1')}
                className="ml-16"
              />
              <List
                variant="ordered"
              ...
              />
              <List
                items={tList('pages.privacy-policy.items3-2-1')}
                className="ml-16"
              />
              <List
                variant="ordered"
            ...
            <Section id="6" title={t('pages.privacy-policy.title6')}>
              ...
              <Paragraph className="md:mb-6">
                {t('pages.privacy-policy.paragraph6-5')}
              </Paragraph>
            </Section>
            ...
            <Section id="10" title={t('pages.privacy-policy.title10')}>
              ...
              <List items={tList('pages.privacy-policy.items10-2')} />
              <Paragraph className="md:mb-6">
                {t('pages.privacy-policy.paragraph10-4')}
              </Paragraph>
              <Paragraph>{t('pages.privacy-policy.paragraph10-5')}</Paragraph>
            </Section>
            ...
            <Section id="11" title={t('pages.privacy-policy.title11')}>
              ...
              <List items={tList('pages.privacy-policy.items11-1')} />
