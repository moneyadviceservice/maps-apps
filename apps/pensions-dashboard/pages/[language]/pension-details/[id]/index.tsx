...
const Page: NextPage<PensionsDashboardLayoutProps & PageProps> = ({
  ...
  const isSP = data.pensionType === PensionType.SP;
  const titleKey = isSP
    ? 'pages.pension-details.state-pension'
    : 'pages.pension-details.title';
  const titleParams = isSP ? undefined : { name: data.schemeName };
  ...
  return (
    <PensionsDashboardLayout
      ...
      title={title}
      helpAndSupport
      isOffset={data.pensionType !== PensionType.SP}
    >
