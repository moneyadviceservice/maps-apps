...
/**
 * Gets a BenefitIllustration that contains a lump sum illustration component with the earliest payable date
 * @param benefitIllustrations
 * @returns BenefitIllustration or undefined
 */
...
/**
 * Gets a BenefitIllustrationComponent that contains a lump sum illustration component with the earliest payable date
 * @param type
 * @param benefitIllustrations
 * @returns BenefitIllustrationComponent or undefined
 */
export const getLumpSumIllustration = (
  ...
  return illustration.illustrationComponents.find(
