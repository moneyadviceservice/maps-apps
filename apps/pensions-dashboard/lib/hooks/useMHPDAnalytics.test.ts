...
describe('useMHPDAnalytics', () => {
  ...
  beforeEach(() => {
    ...
    // Enable analytics for all tests by default and set production mode
    (process.env as any).NODE_ENV = 'production';
    (process.env as Record<string, string | undefined>)[
      'NEXT_PUBLIC_ENABLE_ANALYTICS'
    ] = 'true';
    // Set as deployed environment by default so addEvent gets called
    (process.env as Record<string, string | undefined>)['NETLIFY'] = 'true';
  });
  ...
  describe('feature flag control', () => {
    ...
    beforeEach(() => {
      originalEnableAnalytics = process.env.NEXT_PUBLIC_ENABLE_ANALYTICS;
      (process.env as any).NODE_ENV = 'production';
    });
    ...
    afterEach(() => {
      if (originalEnableAnalytics === undefined) {
        ...
        process.env.NEXT_PUBLIC_ENABLE_ANALYTICS = originalEnableAnalytics;
      }
    });

    it('should send analytics when feature flag is enabled', () => {
    ...
    it('should NOT send analytics when feature flag is disabled', () => {
    ...
    it('should NOT send analytics when feature flag is undefined', () => {
      delete process.env.NEXT_PUBLIC_ENABLE_ANALYTICS;
    ...
    it('should log and NOT send analytics when running locally', () => {
      ...
      // Set as local development (no NETLIFY, no CONTEXT, not production)
  ...
  describe('console logging', () => {
    ...
    beforeEach(() => {
      ...
      // Enable analytics for console logging tests and set production mode
      setEnvironmentVars({
        NODE_ENV: 'production',
    ...
    it('should log and send event when deployed with analytics enabled', () => {
      setEnvironmentVars({
      ...
      // Should log when deployed with analytics enabled
      expect(consoleSpy).toHaveBeenCalledWith(
    ...
    it('should NOT log and NOT send event when deployed with analytics disabled', () => {
      setEnvironmentVars({
        NODE_ENV: 'production', // Deployed
      ...
      // Should not log when deployed with analytics disabled
      expect(consoleSpy).not.toHaveBeenCalled();
      // Should not send the event when analytics disabled
      expect(mockAddEvent).not.toHaveBeenCalled();
    });
  });
});
