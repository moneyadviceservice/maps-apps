        ...
        {showHeaders && (
          <thead>
            <tr>
              ...
              <th className="sticky left-0 z-20 py-3 text-base font-bold text-left text-gray-800 bg-white border-r border-gray-200"></th>
            ...
            <React.Fragment key={rowIdx}>
              ...
              {row.expandableKey && expandableContentMap[row.expandableKey] && (
                <tr>
                  ...
                  >
                    <ExpandableSection
                      testClassName="py-0 ml-[8px] -mt-[4px] mr-[8px]"
                      variant="hyperlink"
                      ...
                      title={
                        <span className="text-[12px] font-normal leading-[140%] tracking-[0.12px] relative z-20">
                          {z({ en: 'More info', cy: 'LlaiMwy o wybodaeth' })}
                        </span>
                      }
                      closedTitle={
                        <span className="text-[12px] font-normal leading-[140%] tracking-[0.12px] relative z-20">
                          {z({ en: 'Less info', cy: ' o wybodaeth' })}
                        </span>
                      }
                    >
