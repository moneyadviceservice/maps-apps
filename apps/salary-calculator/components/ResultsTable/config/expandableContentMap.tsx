...
> = {
  grossIncome: (z) =>
    z({
      ...
      cy: (
        <Paragraph className="text-[16px]">
          Incwm gros yw eich cyflog cyn i unrhyw beth arall gael ei dynnu. Nid
          yw’n eich cyflog i’w gymryd adref.
        </Paragraph>
      ),
    }),
  personalAllowance: (z) =>
    z({
      ...
      cy: (
        <>
          <Paragraph>
            Lwfans personol yw’r swm y gallwch ei ennill cyn i dreth gael ei
            thynnu o’ch incwm gros. Dysgwch ragor am sut mae hyn yn gweithio ar{' '}
            <Link
          ...
          <Paragraph>
            <strong>Mwy am lwfansau personol:</strong> Os ydych wedi priodi neu
            mewn partneriaeth sifil, gallech ystyried cynyddu eich Lwfans
            Personol gyda’r{' '}
            <Link
    ...
    z({
      ...
      cy: (
        <Paragraph className="text-[16px]">
          ...
          yn newid. Maent yn cael y wybodaeth hon gan eich cyflogwr. Os oes oedi
          neu os oes rhywfaint o wybodaeth ar goll, efallai y cewch eich rhoi ar
          god treth brys. Dyma{' '}
          <Link
            href="https://www.gov.uk/tax-codes/emergency-tax-codes"
            target="_blank"
            ...
            withIcon={false}
          >
            beth i’w wneud os ydych ar god treth brys
          </Link>
          .
        </Paragraph>
      ),
