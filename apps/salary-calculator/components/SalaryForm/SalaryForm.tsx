...
const getFrequencyOptions = (z: ReturnType<typeof useTranslation>['z']) => [
  ...
  { text: z({ en: 'Hourly', cy: 'Yr awr' }), value: 'hourly' },
];
  ...
  const planLabels = {
    ...
    plan2: {
      ...
      desc: z({
        ...
        cy: 'Lloegr - 2012-2023 neu Cymru - ar ôl 2012.',
      }),
    },
    plan4: {
      ...
      desc: z({
        ...
        cy: 'Yr Alban - ar ôl 1998; a phob benthyciad ôl-raddedig yn yr Alban.',
      }),
    },
    plan5: {
...
export const SalaryForm = ({
  ...
  const DescriptionText = {
    ...
    additionalInfo: z({
      ...
      cy: 'Bydd manylion ychwanegol yn rhoi cyfrifiad mwy cywir i chi.',
    }),

    pensionContributions: z({
      en: 'Not sure? You can check by: looking at your payslip, contacting your pension provider.',
      cy: "Ddim yn siŵr? Gallwch wirio os yw eich pensiwn yn 'cyflog net' trwy: edrych ar eich slip cyflog, cysylltu â'ch darparwr pensiwn.",
    }),
    studentLoan: z({
    ...
    blindPersonAllowance: z({
      en: "If you're registered as blind or severely sight impaired you may be entitled to an extra tax allowance.",
      cy: "Os ydych wedi'ch cofrestru fel person dall neu â nam difrifol ar eich golwg, efallai y byddwch yn gymwys i gael lwfans treth ychwanegol.",
    }),
  };
    ...
    >
      ...
      <div className="px-4 py-4 lg:px-6 lg:py-8">
        ...
        <div className="flex mt-6 lg:mt-8">
          ...
          />
          <label
            htmlFor={prefixField('checkboxIsScottish')}
            className="text-gray-800 mt-1 mb-0 text-[24px] font-bold"
          >
            {z({
              en: 'Do you live in Scotland?',
              cy: "Ydych chi'n byw yn yr Alban?",
        ...
        <div className="flex flex-col mt-6 lg:mt-8">
          ...
          <Paragraph id="taxcode-help" className="mb-2">
        ...
        <div
          className={`${!isJsEnabled || expanded ? 'block' : 'hidden'}`}
          ...
          <div className="pt-0 space-y-6 lg:space-y-8">
            <OptionalInfoFieldset
              ...
              description={{
                ...
                cy: 'Os ydych yn cyfrannu at gynllun pensiwn gweithle neu bersonol.',
              }}
              paragraph={{
                en: 'Not sure? You can check by:',
                cy: "Ddim yn siŵr? Gallwch wirio os yw eich pensiwn yn 'cyflog net' trwy:",
              }}
              listItems={[
                {
            ...
            <OptionalInfoFieldset
              ...
              listItems={[
                { en: 'where you are from', cy: 'o ble rydych chi' },
                {
                  en: 'when you started your course.',
                  cy: 'pryd gwnaethoch chi ddechrau eich cwrs',
                },
              ]}
            >
            ...
            >
              <Paragraph className="mt-4 mb-2">
                {z({
                  ...
                  cy: 'Os ydych dros oedran Pensiwn y Wladwriaeth, rydych chi fel arfer yn stopio talu cyfraniadau Yswiriant Gwladol, felly mae hyn yn effeithio ar eich canlyniad. Os gadewch hwn yn wag, byddwn yn cymryd eich bod yn dal i dalu cyfraniadau YG.',
                })}{' '}
                <Link
              ...
              <div className="flex items-center mt-6 gap-x-8">
                <RadioButton
                  ...
                  aria-describedby={DescriptionText.statePensionAge}
                >
                  {z({ en: 'Yes', cy: 'Ie' })}
                </RadioButton>
            ...
            <OptionalInfoFieldset
              title={{
                ...
                cy: 'Ydych chi’n cael Lwfans Person Dall?',
              }}
            >
              <Paragraph
                className="mt-4 mb-2"
              ...
              >
                ...
                >
                  {z({
                    en: 'Gov.uk',
                    cy: 'Darganfyddwch fwy am Lwfans Person Dall (yn agor mewn tab newydd)',
                  })}
                </Link>
                .
              </Paragraph>
              ...
              <div className="flex items-center mt-6 gap-x-8">
                <RadioButton
                  ...
                  aria-label={z({
                    ...
                    cy: 'Ie. ' + DescriptionText.blindPersonAllowance,
                  })}
                >
                  {z({ en: 'Yes', cy: 'Ie' })}
                </RadioButton>
