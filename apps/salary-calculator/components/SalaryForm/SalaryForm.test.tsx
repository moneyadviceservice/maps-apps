...
import { SalaryForm, isHoursAllowed, isDaysAllowed } from './SalaryForm';
...
describe('SalaryForm', () => {
  ...
  describe('Validation helpers', () => {
    describe('isHoursAllowed', () => {
      it('allows valid hours between 0 and 168', () => {
        expect(
          isHoursAllowed({ floatValue: 40, formattedValue: '40', value: '40' }),
        ).toBe(true);
        expect(
          isHoursAllowed({ floatValue: 0, formattedValue: '0', value: '0' }),
        ).toBe(true);
        expect(
          isHoursAllowed({
            floatValue: 168,
      ...
      it('rejects hours greater than 168', () => {
        expect(
          isHoursAllowed({
            floatValue: 169,
            formattedValue: '169',
    ...
    describe('isDaysAllowed', () => {
      it('allows valid days between 0 and 7', () => {
        expect(
          isDaysAllowed({ floatValue: 5, formattedValue: '5', value: '5' }),
        ).toBe(true);
        expect(
          isDaysAllowed({ floatValue: 0, formattedValue: '0', value: '0' }),
        ).toBe(true);
        expect(
          isDaysAllowed({ floatValue: 7, formattedValue: '7', value: '7' }),
        ).toBe(true);
      });

      it('rejects days greater than 7', () => {
        expect(
          isDaysAllowed({ floatValue: 8, formattedValue: '8', value: '8' }),
        ).toBe(false);
      });

      it('rejects multiple digits', () => {
        expect(
          isDaysAllowed({ floatValue: 12, formattedValue: '12', value: '12' }),
        ).toBe(false);
      });
