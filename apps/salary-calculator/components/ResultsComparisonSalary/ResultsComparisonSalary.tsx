  ...
  return (
    <div id="results-comparison">
      <div className="grid grid-cols-12 mb-8">
        ...
        >
          Breakdown of take home pay for each salary
        </Heading>

        {/* Description row */}
        <Paragraph className="text-gray-800 text-[30px] lg:text-[42px] leading-[42px] mt-6 lg:mt-8 col-span-12">
          Your take home pay difference is{' '}
          <span className="font-bold">{formattedDifference}</span>.
        </Paragraph>

        <Paragraph className="text-gray-800 text-[18px] lg:text-[24px] col-span-12">
          {isEqual
            ? 'Both salaries are the same.'
            : `${isSalary2Higher ? 'Salary 2' : 'Salary 1'} is higher than ${
                isSalary2Higher ? 'Salary 1' : 'Salary 2'
              } by this amount per ${frequencyLabels[resultsFrequency]}.`}
        </Paragraph>
        ...
        <div className="col-span-12 xl:col-span-10">
          <ResultsHelpText className="mt-0 lg:mt-8" />
        </div>
        ...
        {/* Desktop */}
        <div className="hidden grid-cols-12 col-span-12 gap-6 mt-4 lg:grid lg:mt-8">
          <UrgentCallout
            border="teal"
            variant="mortgage"
