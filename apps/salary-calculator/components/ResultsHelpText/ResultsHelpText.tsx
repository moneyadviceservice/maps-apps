  ...
  return (
    <Paragraph variant="primary" className={className}>
      {z({
        en: (
          <>
            This is an estimate based on the information you have provided. For
        ...
        cy: (
          <>
            Mae hwn yn amcangyfrif yn seiliedig ar y wybodaeth rydych
            wedi&apos;i ddarparu. . I gael canlyniadau manylach,{' '}
            <Link
              href="https://www.gov.uk/contact-hmrc"
              target="_blank"
              asInlineText
