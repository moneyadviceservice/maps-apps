...
describe('calculateIncomeTax - Cumulative PAYE Mode', () => {
  ...
  const minimalMockTaxRates: EnglishTaxRates = {
    ...
    STUDENT_LOAN_PLAN_1_WEEKLY_THRESHOLD: 0,
    STUDENT_LOAN_PLAN_2_WEEKLY_THRESHOLD: 0,
    STUDENT_LOAN_PLAN_4_WEEKLY_THRESHOLD: 0,
    STUDENT_LOAN_PLAN_5_WEEKLY_THRESHOLD: 0,
    STUDENT_LOAN_REPAYMENT_AMOUNT: 0,
    STUDENT_LOAN_POSTGRAD_WEEKLY_THRESHOLD: 0,
