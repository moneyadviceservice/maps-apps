...
export const contributionData = (
  ...
  return {
    ...
    legalMinimumPart: t({
      en: 'The legal minimum that must be paid into your pension is 8% a year. At least 3% of this must be paid by your employer. The usual split is 5% from employees and 3% from employers.',
      cy: `Y ffigwr gofynnol cyfreithiol sydd yn rhaid ei dalu i mewn i'ch pensiwn yw 8% y flwyddyn. Rhaid i'ch cyflogwr dalu 3% o leiaf ohono. Y rhaniad fel arfer yw 5% gan gyflogeion a 3% gan gyflogwyr.`,
    }),
    legalMinimumFull: t({
      en: (
        <>
          <p>
            ...
            employer makes contributions based on your <strong>full</strong>{' '}
            earnings instead, including bonuses, overtime and commission. At
            least 3% of this must still come from your employer. This calculator
            does not cover cases where the total contribution is lower than 8%.
            See our page on{' '}
            <Link
              target="_blank"
      ...
      cy: (
        <>
          <p>
            ...
            leiaf 3% o hyn ddod gan eich cyflogwr o hyd. Nid yw'r gyfrifiannell
            hon yn cynnwys achosion lle mae cyfanswm y cyfraniad yn is nag 8%.
            Gweler ein tudalen ar{' '}
            <Link
              target="_blank"
