  ...
  return (
    ...
    >
      ...
      <div className="mt-4 print:hidden">
        ...
        <ol className="mt-4 ml-8 space-y-2 list-decimal marker:font-bold marker:text-blue-800 marker:mr-2 marker:pr-2 marker:leading-snug">
      ...
      {jsEnabled && (
        <li>
          <Link
            ...
            className="mb-3 text-sm visited:text-pink-600"
          >
            {links?.print}
          </Link>
        </li>
