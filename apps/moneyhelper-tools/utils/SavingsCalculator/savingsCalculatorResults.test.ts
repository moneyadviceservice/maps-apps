...
**/
  xit('should return correct results with saving goal 25000 and savingDate 6 months from now', () => {
  ...
  xit('should return correct results with saving goal 18000 weekly', () => {
    const result = savingsCalculatorResults({
      savingGoal: 18000,
      regularDeposit: 100,
