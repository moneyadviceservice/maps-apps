  ...
  },
  {
    ...
    content: [
      ...
      sectionContent(
        ...
        [
          {
            en: 'Late fees and interest if you miss a payment',
            cy: 'Ffioedd hwyr a llog',
          },
          {
          ...
          },
          {
            ...
            cy: "Nid yw'r rhan fwyaf ohonynt yn cael eu rheoleiddio, felly ychydig o amddiffyniad sydd gennych os bydd pethau'n mynd o'i le",
          },
        ], // cons
        {
          en: (
...
const data: Data = {
  ...
  noResultsIntro: {
    en: (
      <>
        <span className="block pb-4 mt-8 text-2xl font-bold">
    ...
    cy: (
      <>
        <span className="block pb-4 mt-8 text-2xl font-bold">
          Does dim canlyniadau ar gyfer eich chwiliad.
        </span>
        <span className="text-base">
