...
export const DateOfBirth: StepComponent = ({ errors, entry, step, flow }) => {
  const { t } = useTranslation();

  return (
    <FormWrapper step={step} className="pt-4 md:max-w-xl">
      <Errors errors={hasFieldError(errors, 'dates')}>
        <Paragraph className="text-gray-400" data-testid="date-of-birth-hint">
      ...
      >
        <Markdown
          content={t(
            `components.date-of-birth.expandable-section.${flow}.content`,
          )}
