...
import { FlowName, ResponseMessage, StepName } from '../../lib/constants';
...
export default async function (req: Request) {
  if (req.method === 'POST') {
    ...
    try {
      ...
      if (errors) {
        // Validation failed - update data and errors, leave the stepIndex unchanged so user is redirected back to same step
