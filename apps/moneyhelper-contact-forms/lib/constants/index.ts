...
> = {
  ...
  [FlowName.PENSIONS_AND_RETIREMENT]: {
    enquiryType: 'pensions - general',
    kindofEnquiry: 1,
  },
  [FlowName.DEBT_ADVICE]: { enquiryType: 'debt advice' },
  [FlowName.INSURANCE]: { enquiryType: 'insurance - other', kindofEnquiry: 8 },
  ...
  [FlowName.APPOINTMENT_PENSION_WISE]: {
    enquiryType: 'appointment - pensionwise',
    kindofEnquiry: 4,
  },
  [FlowName.APPOINTMENT_DIVORCE]: {
    enquiryType: 'appointment - divorce',
    kindofEnquiry: 5,
  },
};
