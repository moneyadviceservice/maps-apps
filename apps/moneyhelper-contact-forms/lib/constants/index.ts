...
export const HEADING_MAP: Record<string, string> = {
  [FlowName.INSURANCE]: StepName.INSURANCE_TYPE,
  [FlowName.PENSIONS_AND_RETIREMENT]: StepName.PENSION_TYPE,
  [FlowName.PENSIONS_APPOINTMENTS]: StepName.APPOINTMENT_TYPE,
};
