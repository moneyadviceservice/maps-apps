        ...
        <Container className="max-w-[1272px]">
          ...
          <div className="pt-4 pb-10 mt-6 text-center border-t border-white">
            <Paragraph className="text-white">
              {z({
                en: 'Copyright 2025 Money & Pensions Service, Borough Hall, Cauldwell Street, Bedford, MK42 9AB. All rights reserved.',
                cy: 'Copyright 2025 Money & Pensions Service, Borough Hall, Cauldwell Street, Bedford, MK42 9AB. All rights reserved.',
              })}
            </Paragraph>
          </div>
        </Container>
