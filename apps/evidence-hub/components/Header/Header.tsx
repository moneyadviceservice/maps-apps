...
export const Header = ({
  ...
  const skipMainFocusStyles =
    'focus:z-20 focus:not-sr-only focus:bg-yellow-200 focus:border-b-4 focus:border-b-blue-800 focus:absolute focus:p-2 focus:rounded focus:top-4 focus:left-4 focus:z-50';
                      ...
                      {mainNavigation?.map((i) => (
                        <li key={i.linkTo}>
                          <Link
                            ...
                            className={twMerge(
                              i.linkTo === `/${activePath}` ? [] : '',
                              'py-2 w-full relative px-4 no-underline text-lg font-bold text-pink-600 visited:text-gray-600',
                            )}
                          >
                            {i.text}
                            <Icon
                              type={IconType.CHEVRON}
                              className="ml-auto text-pink-600"
                            ></Icon>
                          </Link>
                        </li>
                      ))}
