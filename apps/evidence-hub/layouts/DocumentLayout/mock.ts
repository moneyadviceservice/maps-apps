export const mock = {
  seoTitle: 'Funding and operating models of the debt advice sector',
  seoDescription: 'Funding and operating models of the debt advice sector',
  slug: 'funding-and-operating-models-of-the-debt-advice-sector',
  publishDate: '2025-08-12',
  lastUpdatedDate: '2025-08-11',
  pageType: { name: 'Evaluation', key: 'evaluation' },
  dataType: [
    { name: 'Qualitative', key: 'qualitative' },
    { name: 'Quantitative', key: 'quantitative' },
  ],
  title: 'Funding and operating models of the debt advice sector',
  links: [
    {
      linkTo: '#context',
      text: 'Context',
      ...
      json: [
        {
          nodeType: 'header',
          style: 'h2',
          content: [{ nodeType: 'text', value: 'Context' }],
        },
        {
          nodeType: 'paragraph',
          content: [
      ...
      json: [
        {
          nodeType: 'header',
          style: 'h2',
          content: [{ nodeType: 'text', value: 'The study' }],
        },
        {
          nodeType: 'paragraph',
          content: [
      ...
      json: [
        {
          nodeType: 'header',
          style: 'h2',
          content: [{ nodeType: 'text', value: 'Key findings' }],
        },
        {
          nodeType: 'paragraph',
          content: [
  ...
  clientGroup: [{ name: 'Other', key: 'other' }],
  topic: [{ name: 'Saving', key: 'saving' }],
  countryOfDelivery: [{ name: 'United Kingdom', key: 'uk' }],
  contactInformation: {
    json: [
      {
        nodeType: 'paragraph',
