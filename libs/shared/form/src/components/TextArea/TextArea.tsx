...
export const TextArea = ({
  ...
  return (
    <>
      ...
      {hint && (
        <Paragraph
          className={twMerge('text-gray-650', error ? 'mb-2' : '')}
          data-testid={hintId}
        >
          {hint}
        </Paragraph>
      ...
      <textarea
        ...
        aria-labelledby={id} // Associates the label with the textarea
      ...
      {hasCharacterCounter && (
        <p className="text-base text-gray-650" aria-live="polite">
          {z({
