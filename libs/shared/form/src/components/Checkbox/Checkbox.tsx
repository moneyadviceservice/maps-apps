...
const focusClasses = `
  peer-focus:border-4 peer-focus:border-blue-800 peer-focus:ring-4 peer-focus:ring-yellow-200
`;

const hoverClasses = `
  hover:bg-pink-800 hover:text-white hover:border-pink-800
  peer-checked:hover:bg-pink-800 peer-checked:hover:border-pink-800
`;
