...
export const Select = ({
  ...
  return (
    <div
      className={twMerge(
        'relative block focus-within:rounded focus-within:ring-4 focus-within:ring-yellow-200 focus-within:ring-offset-4 focus-within:ring-offset-blue-800',
        hasError
    ...
    >
      ...
      <select
        ...
        className={twMerge(
          ...
          } print:p-1 text-gray-500 w-full block text-md h-10 pl-3 pr-12 bg-white rounded tool-dd outline-none focus:outline-none focus:border-white`,
          selectClassName,
        )}
        onChange={onChange}
      >
