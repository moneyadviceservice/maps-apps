...
const labelStyles = {
  ...
  hover: 'peer-checked:hover:after:border-pink-800 peer-focus:hover:after:border-pink-600',
  active: 'active:after:opacity-100 active:after:border-white peer-checked:active:after:border-pink-400 peer-disabled:active:after:border-gray-200 peer-focus:active:after:border-pink-600',
  inputFocus:
    'peer-focus:before:border-4 peer-focus:before:border-blue-800 peer-focus:before:outline-[3px] peer-focus:before:outline-black peer-focus:before:outline-offset-1 peer-focus:before:shadow-[0_0_0_3px] peer-focus:before:shadow-yellow-200',
