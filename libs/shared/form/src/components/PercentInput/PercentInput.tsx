    ...
    <div className={twMerge("flex", containerClassName)}>
      <div className={twMerge("relative", inputClassName)}>
        <NumberInput
          ...
          className={twMerge(
            "peer border-gray-400 py-[8px] pr-12 border rounded focus:border-blue-800",
            inputBackground,
          )}
          inputMode="decimal"
          {...rest}
        ...
        <span
          aria-hidden
          className="absolute top-0 right-0 bg-gray-100 px-3 h-full rounded-r border-gray-400 border border-solid justify-center flex items-center peer-focus:border-blue-800 peer-focus:border-l-gray-400"
        >
          %
        </span>
      </div>
