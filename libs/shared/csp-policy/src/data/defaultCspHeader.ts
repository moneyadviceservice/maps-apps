...
export const defaultCspHeader = {
  'default-src': "'self'",
  'script-src':
    "'self' *.civiccomputing.com *.cdn.civiccomputing.com *.clarity.ms *.bing.com *.bing.net *.adobedtm.com assets.adobedtm.com *.everesttech.net *.demdex.net *.omtrdc.net *.netlify.app *.moneyhelper.org.uk \
  ...
  'img-src':
    ...
    *.glassboxdigital.com *.glassboxdigital.io *.moneyhelper.org.uk",
  'connect-src':
    "'self' *.adobedtm.com *.demdex.net *.omtrdc.net www.google.co.uk/ads/ga-audiences wss://webmessaging.euw2.pure.cloud bat.bing.com *.google.com px.ads.linkedin.com api-cdn.euw2.pure.cloud \
    ...
    *.google-analytics.com *.analytics.google.com maps-uk.sc.omtrdc.net *.googletagmanager.com moneypensions.tt.omtrdc.net cdn.linkedin.oribi.io pagead2.googlesyndication.com *.bugcrowd.com \
    assets.bugcrowdusercontent.com *.gbqofs.io *.nsvcs.net",
  'frame-src':
  ...
  'base-uri': "'self'",
  'form-action':
    "'self' *.netlify.app *.netlify.com *.moneyhelper.org.uk prod-webforms.powerappsportals.com www.facebook.com",
