            ...
            >
              {(step === 2 || step === 3) && (
                <button
                  ...
                  className="flex flex-row items-center justify-end text-pink-600 t-chat-panel-previous hover:text-pink-900 hover:underline focus:text-gray-800 focus:bg-yellow-200 focus:shadow-link-focus outline-0"
                  onClick={onBack}
                >
              ...
              <button
                className="flex flex-row items-center justify-end text-pink-600 t-chat-panel-close hover:text-pink-900 hover:underline focus:text-gray-800 focus:bg-yellow-200 focus:shadow-link-focus outline-0"
                onClick={onClose}
              >
                <Icon
