...
const ContactStepThreeCard = ({
  ...
  return (
    <Link
      ...
      className="right-0 flex w-full px-4 py-2 mr-2 text-xl text-pink-600 bg-white border border-pink-600 rounded t-chat-panel-button-inline outline-0 shadow-bottom-gray top-1/2 my-7 solid hover:bg-gray-100 hover:text-pink-800 focus:text-gray-800 focus:bg-yellow-200 focus:border-purple-700 focus:border-2 focus:shadow-none"
    >
