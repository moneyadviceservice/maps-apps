        ...
        {content.otherPhones.map((v) => {
          return (
            <li key={slug(v.title)} className="flex pb-4">
              ...
              <Link
                href={'tel://' + v.num}
                className="pl-3 text-pink-600 underline outline-0 hover:no-underline hover:text-pink-900 focus:no-underline focus:text-gray-800 focus:bg-yellow-200 focus:shadow-link-focus"
              >
                {v.num}
              </Link>
            </li>
    ...
    <>
      ...
      <div className="flex pb-4">
        ...
        <Link
          ...
          target="_blank"
          className="pl-1 text-pink-800 underline hover:no-underline hover:text-pink-900 focus:no-underline focus:text-gray-800 focus:bg-yellow-200 focus:shadow-link-focus"
        >
          WhatsApp
        </Link>
      </div>
