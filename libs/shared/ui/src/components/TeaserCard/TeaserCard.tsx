...
const defaultClasses = [
  't-teaser flex flex-col outline outline-1 outline-slate-400 shadow-bottom-gray rounded md:rounded-none md:rounded-bl-[36px] md:shadow-none overflow-hidden text-magenta-500 bg-white',
];
const hoverClasses = [
