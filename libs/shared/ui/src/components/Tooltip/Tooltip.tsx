...
export const Tooltip = ({
  ...
  return (
    <span
      className="relative inline-block top-[4px] md:top-[2px]"
      data-testid={testId}
    >
      <input
        type="checkbox"
      ...
      >
        <Icon
          className={twMerge(
            '!w-[30px] !h-[30px] [&_circle]:fill-yellow-100 [&_path]:fill-pink-600 group-focus-within:[&_circle]:fill-pink-600 group-focus-within:[&_path]:fill-yellow-100 group-hover:[&_circle]:fill-pink-600 group-hover:[&_path]:fill-yellow-100',
            isOpen && '[&_circle]:fill-pink-600 [&_path]:fill-yellow-100',
          )}
