...
export const useCookieConsent = (config?: {
  locales?: unknown[];
  text?: unknown;
}) => {
    ...
    locales: [
      {
        ...
        text: {
          ...
          notifyDescription:
            "<p>Rydym yn defnyddio cwcis hanfodol i wneud i'r wefan hon weithio a chwcis dadansoddeg yn ddiofyn i wella ein gwasanaethau. Hoffem osod 'cwcis marchnata' i ddeall beth sy'n gweithio orau i gynyddu ymwybyddiaeth o HelpwrArian.<p></p><p><img width='190' height='64' src='/footer/gov-cy.svg' /></p>",
