...
Each application requires environment variables to run properly:
...
npm run test:e2e moneyhelper-tools-baby-costs-calculator-e2e
npm run test:e2e moneyhelper-tools-baby-money-timeline-e2e
...
- **netlify/netlify-pr-review.yml** - PR code analysis and E2E tests for affected apps
- **netlify/netlify-azure-pipelines.yml** - Deploy apps to environments
- **netlify/netlify-dev-on-merge.yml** - Runs when PR merged, resets develop to main

### Environment Deployment

**'Netlify - Deploy to Environment' Pipeline Options:**

- **Branch/tag** - The branch or tag to deploy
- **App to deploy** - The specific app to deploy
- **Environment** - test, staging, or custom
- **Custom Environment** - Custom alias (if 'custom' selected)
- **Environment variables** - Which set of environment variables to use
- **Custom environment variables** - Comma-separated list (Key1=Value1, Key2=Value2)
- **Run e2e tests** - Whether to run E2E tests for the selected app
