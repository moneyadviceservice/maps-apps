...
- Custom environment variables
  - Provide a comma seperated list of environment variables (Key1=Value1, Key2=Value2)
  - These are loaded into netlify and then deleted after the specific build
  - Indented for testing/demo'ing of new features.
- Run e2e tests
